...
<html>
	...
	<body>
	<form action="${ctx}/user/bigdelete?page=${page }&checknum2=1&checknum=1" method="post">
		<table cellspacing="4" cellpadding="0" class="table">
				<tr>
					...
					<th class="tr-th1" style="display:table-cell; vertical-align:middle">课程名</th>
					<th class="tr-th1" style="display:table-cell; vertical-align:middle">课程机构</th>
					<th class="tr-th1" style="display:table-cell; vertical-align:middle">价格</th>
					<th class="tr-th1" style="display:table-cell; vertical-align:middle">时间</th>
					<th class="tr-th2" style="display:table-cell; vertical-align:middle">操作</th>
				</tr>
