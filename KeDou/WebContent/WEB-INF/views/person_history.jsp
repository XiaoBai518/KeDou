...
<body>
<form action="${ctx}/user/bigdelete?page=${page }&checknum=2" method="post">
		<table cellspacing="4" cellpadding="0" class="table">
			...
			<tr class="test" id="${p.courseId }">
					...
					<th  class="tr-td1" id="${p.courseId }" style="display:table-cell; vertical-align:middle"><a href="${ctx}/user/delete?courseid=${p.courseId}&page=${page }&checknum=2"><div class="delete"><i class="icon icon-trash icon-1x"></i></div></a></th>
		...
		<div class="page">
			<ul id="myPager" class="pager" data-ride="pager" data-page="${page}" data-rec-Total="${pagecount }" data-rec-Per-Page="3" data-link-creator="${ctx }/user/page?page={page}&totalCount={recTotal}&checknum=2" ></ul>
		</div>	
		<script>
		ischeck = 0;
		//全选按钮2
