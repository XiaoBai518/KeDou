...
<body>
		<table cellspacing="4" cellpadding="0" class="table">
			...
			<tr class="test" id="${p.courseId }">
					...
					<th  class="tr-td1" id="${p.courseId }" style="display:table-cell; vertical-align:middle"><a href="${ctx}/torder/delete?courseid=${p.courseId}&page=${page }"><div class="delete"><i class="icon icon-trash icon-1x"></i></div></a></th>
